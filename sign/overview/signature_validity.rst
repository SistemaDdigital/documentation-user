...
international levels, and `UETA (Uniform Electronic Transactions Act)
...
<https://its.ny.gov/electronic-signatures-and-records-act-esra>`_ have not adopted UETA, but similar
acts instead.
...
#. The signature must be associated with the document being signed, for example, by keeping a record
   that details how the signature was captured.
...
.. note::
   ...
   guarantee that the information is current. We advise you to should contact a local attorney to
   obtain legal advice.